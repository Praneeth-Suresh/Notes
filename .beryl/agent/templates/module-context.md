...
2. This module's `.beryl/agent/` files.
...
- `.beryl/agent/project-brief.md` (module goal, not whole-project goal)
- `.beryl/agent/design-tree.md` (module-level decisions)
- `.beryl/agent/architecture.md` (internal boundaries within this module)
- `.beryl/agent/ubiquitous-language.md` (module-local terms, supplements root)
- `.beryl/agent/testing-policy.md` (module-specific commands)
