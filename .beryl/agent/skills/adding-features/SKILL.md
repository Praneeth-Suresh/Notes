...
8. Update `.beryl/agent/session-state.md` only if more work remains or the slice is blocked.
9. Clear `.beryl/agent/session-state.md` when the feature is complete.
