...
| Homepage section atlas | Replace the rounded five-section homepage rail with a sharp segmented section atlas: each segment has a large slash-name, small supporting label, strong dividers, black/purple hero context, and a green research handoff. | 2026-07-01 | n/a |
...
- The homepage five-section navigation now uses a sharp segmented atlas with the slash section names as the primary visual hierarchy and smaller subtitles for supporting context.
