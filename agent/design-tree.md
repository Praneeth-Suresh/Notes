...
| site-styling-portfolio-refresh-006 | `site-styling` | planned | Add local GitHub repository refresh data and subtitle update tooling while preserving static Pages deployment. | Start after UI polish commit. |
