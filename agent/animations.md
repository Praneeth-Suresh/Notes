...
- `agent/design-tree.md` for durable UX decision updates after implementation
...
checks_to_run:
  ...
  broad: ["./scripts/check.sh", "Playwright MCP verification of desktop, mobile, reduced-motion, sticky hold, and stable clickable cards"]
