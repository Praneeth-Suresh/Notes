...
.proof-graph-visual::before,
.research-signal-visual::before,
.research-signal-visual::after {
  content: "";
  position: absolute;
  pointer-events: none;
}
...
.proof-graph-visual::before {
  inset: 18% 12%;
  background:
    linear-gradient(34deg, transparent 0 47%, var(--border) 47% 49%, transparent 49%),
    linear-gradient(146deg, transparent 0 48%, var(--border) 48% 50%, transparent 50%),
    linear-gradient(90deg, transparent 0 49%, var(--accent-strong) 49% 51%, transparent 51%);
  opacity: 0.58;
}

.proof-graph-visual span,
.research-signal-visual span {
  position: absolute;
  display: grid;
  place-items: center;
  width: 2.75rem;
...
.proof-graph-visual span:nth-child(1) {
  left: 11%;
  top: 16%;
}

.proof-graph-visual span:nth-child(2) {
  right: 13%;
  top: 18%;
}

.proof-graph-visual span:nth-child(3) {
  left: 42%;
  top: 40%;
}

.proof-graph-visual span:nth-child(4) {
  left: 18%;
  bottom: 14%;
}

.proof-graph-visual span:nth-child(5) {
  right: 16%;
  bottom: 13%;
}
...
.research-signal-visual {
  background:
    linear-gradient(120deg, transparent 0 42%, rgb(0 212 255 / 0.18) 42% 45%, transparent 45%),
    linear-gradient(90deg, rgb(30 30 30 / 0.06) 1px, transparent 1px),
    var(--surface-soft);
...
.research-signal-visual span:nth-child(1) {
  left: 10%;
  top: 18%;
}

.research-signal-visual span:nth-child(2) {
  right: 13%;
  top: 19%;
}

.research-signal-visual span:nth-child(3) {
  left: 16%;
  bottom: 15%;
}

.research-signal-visual span:nth-child(4) {
  right: 12%;
  bottom: 16%;
}
