...
.home-page .site-footer {
  ...
  border-color: rgb(248 250 252 / 0.22);
  background:
    linear-gradient(118deg, rgb(139 92 246 / 0.14) 0 31%, transparent 31% 100%),
    linear-gradient(145deg, transparent 0 60%, rgb(16 185 129 / 0.12) 60% 100%),
    #030308;
  color: #f8fafc;
}
